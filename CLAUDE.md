...
- **No Supabase CLI migrations runner yet.** Migrations in `supabase/migrations/` are currently applied manually via the Supabase SQL Editor. The `supabase db push` workflow is not yet configured.
